  ...
  ngOnInit(): void {
    ...
    if (this.payable) {
      this.form.patchValue({
        ...
        isRecurring: this.payable.isRecurring,
        recurrenceClassification: this.payable.recurrenceClassification ?? 'fixed',
        totalInstallments: this.payable.totalInstallments,
        currentInstallment: this.payable.currentInstallment,
